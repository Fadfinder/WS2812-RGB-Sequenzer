...
String demoSequenceBlock(bool enabled = true) {
  String block = String("#SEQ Demo_Sequenz|277000|") + (enabled ? "1\n" : "0\n");
  block += String(
...
const EFFECT_TYPES = ['fire', 'storm', 'rainbow', 'welder', 'camera', 'police', 'sparkle', 'comet', 'theater', 'pulse', 'breathe', 'lava', 'randomOnOff', 'randomColor', 'randomOnOffColor', 'meteor', 'twinkle', 'candle', 'sunrise', 'sunset', 'scanner', 'confetti', 'aurora', 'toxic', 'heartbeat', 'fadeIn', 'fadeOut'];
...
function usesEffectColor(type) {
  return ['sparkle', 'comet', 'theater', 'pulse', 'breathe', 'randomOnOff', 'meteor', 'twinkle', 'scanner', 'heartbeat', 'fadeIn', 'fadeOut'].includes(type);
}
